if game.CoreGui:FindFirstChild("TTJY X POOM HUB X CAT SUS X KTOLLT X XVAS") then
local ddddddddestroy = game.CoreGui["TTJY X POOM HUB X CAT SUS X KTOLLT X XVAS"]
ddddddddestroy:Destroy()
end
task.wait()
-- init
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/GreenDeno/Venyx-UI-Library/main/source.lua"))()
local venyx = library.new("TTJY X POOM HUB X CAT SUS X KTOLLT X XVAS", 5013109572)
...
local ddddddddestroy2 = game.CoreGui["TTJY X POOM HUB X CAT SUS X KTOLLT X XVAS"]
